...
if __name__ == "__main__":
    ...
    parser.add_argument("--fpath", type=str, default="/homes/aonori/Tirocinio/CoOp/output/fairface/CoOp/race/vit_b32_-1shots/nctx16_cscFalse_ctpend/seed1/prompt_learner/model.pth.tar-200", help="Path to the learned prompt")
    ...
    # TODO: problema, se non predice mai una classe, questa non compare nella percentage matrix e fa casini dopo
    ...
    race_Polarization(percentage_matrix, unique_labels, unique_predictions)

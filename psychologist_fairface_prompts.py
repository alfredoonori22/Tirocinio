...
if __name__ == "__main__":
    ...
    parser.add_argument("--fpath", type=str, default="/homes/aonori/Tirocinio/CoOp/output/fairface/CoOp/age/vit_b32_-1shots/nctx16_cscFalse_ctpend/seed1/prompt_learner/model.pth.tar-200", help="Path to the learned prompt")
    ...
    percentage_matrix = create_Heatmap(unique_labels, complete_labels, counts, args.category)
